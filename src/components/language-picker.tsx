...
export function LanguagePicker({
	...
	return (
		...
		>
			<Select.Trigger className="d-f ai-c jc-sb g-1 w-20 px-2 py-1 c-accent-dim fs-sm ff-m us-none c-p bw-0 br-xxl fv:os-s fv:oo-2 fv:oc-accent h:bg-page">
				<Select.Value>
					{() => <span className="min-w-0 o-h to-e ws-nw">{SHORT_LABELS[value]}</span>}
				</Select.Value>
